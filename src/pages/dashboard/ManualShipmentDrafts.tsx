...
const ManualShipmentDrafts = () => {
  ...
  const handleExportPDF = (draft: any) => {
    generateManualShipmentPDF({
      ...
      price_per_unit: draft.price_per_unit?.toString() || '',
      vat_enabled: draft.vat_enabled?.toString() || 'false',
      vat_amount: draft.vat_amount?.toString() || '',
      labor_tax_enabled: draft.labor_tax_enabled?.toString() || 'false',
      labor_tax_percent: draft.labor_tax_percent?.toString() || '',
      labor_tax_amount: draft.labor_tax_amount?.toString() || '',
