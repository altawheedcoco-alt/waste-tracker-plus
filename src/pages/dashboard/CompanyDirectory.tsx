...
const COMPANIES_DATA: Company[] = [
  ...
  // ============ المحلة الكبرى ============
  { name: "شركة مصر للغزل والنسيج بالمحلة", name_en: "Misr Spinning & Weaving (Mahalla)", zone: "المحلة الكبرى", sector: "غزل ونسيج", address: "المنطقة الصناعية، المحلة الكبرى", phone: "", mobile: "", manager: "", position: "", website: "", email: "", description: "من أعرق وأكبر مصانع الغزل والنسيج في مصر والشرق الأوسط" },
  // ============ كفر الدوار ============
  ...
  // ============ دمياط ============
  { name: "مدينة الأثاث بدمياط", name_en: "Damietta Furniture City", zone: "دمياط", sector: "أخشاب وأثاث", address: "المنطقة الصناعية، دمياط", phone: "", mobile: "", manager: "", position: "", website: "", email: "", description: "أكبر مجمع لصناعة الأثاث في الشرق الأوسط" },
];
