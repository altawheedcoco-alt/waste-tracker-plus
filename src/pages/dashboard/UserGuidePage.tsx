        ...
        <div ref={printRef} className="space-y-2">
          ...
          <Section id="generator" icon={Factory} title="لوحة تحكم المولد">
            ...
            <SubSection title="شهادات التدوير">
              <p>متابعة شهادات التدوير من المدورين الشركاء، التحقق من حالتها، وتحميلها كـ PDF.</p>
            </SubSection>
            <SubSection title="الشركاء">
          ...
          <Section id="sidebar" icon={Settings} title="القائمة الجانبية — الأقسام المشتركة">
            ...
            <SubSection title="💬 التواصل">
              <p>دردشة الفريق مع الشركاء، والحالات (Stories) لمشاركة التحديثات.</p>
            </SubSection>
            <SubSection title="📨 الطلبات والتنظيم">
              <p>طلبات الموافقة، السجل التنظيمي، الخطط التشغيلية، وحسابات الشركاء المالية.</p>
            </SubSection>
          </Section>
          ...
          <Section id="communication" icon={MessageCircle} title="التواصل والإشعارات">
            <SubSection title="الدردشة">
              <p>نظام مراسلة فوري بين الشركاء المرتبطين، مع دعم المرفقات والإشعارات.</p>
            </SubSection>
            ...
            <SubSection title="الحالات (Stories)">
              <p>مشاركة التحديثات والإنجازات مع الشركاء بأسلوب بصري.</p>
            </SubSection>
          </Section>
