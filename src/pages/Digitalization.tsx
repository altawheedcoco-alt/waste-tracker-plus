...
const roadmap = [
  { year: "2024", phase: "التأسيس", phaseEn: "Foundation", items: ["بناء البنية التحتية السحابية", "نظام إدارة الشحنات الأساسي", "لوحات تحكم أولية للمولد والناقل"], itemsEn: ["Cloud infrastructure setup", "Core shipment management", "Initial Generator & Transporter dashboards"] },
  { year: "2025 Q1", phase: "التوسع", phaseEn: "Expansion", items: ["إضافة لوحات المدوّر وجهة التخلص", "نظام التوثيق الرقمي والتوقيعات", "محرك الذكاء الاصطناعي v1"], itemsEn: ["Recycler & Disposal dashboards", "Digital documentation & signatures", "AI Engine v1"] },
  { year: "2025 Q2", phase: "النضج", phaseEn: "Maturity", items: ["سوق B2B ونظام المزادات", "الامتثال الرقابي الآلي", "نظام السائقين ثلاثي الفئات"], itemsEn: ["B2B Marketplace & Auctions", "Automated regulatory compliance", "3-tier driver system"] },
  { year: "2025 Q3", phase: "الذكاء", phaseEn: "Intelligence", items: ["وكيل مبيعات AI متعدد القنوات", "التحليلات التنبؤية والتوقعات", "أكاديمية التدريب الرقمية"], itemsEn: ["Multi-channel AI Sales Agent", "Predictive analytics & forecasting", "Digital Training Academy"] },
  { year: "2026+", phase: "الريادة", phaseEn: "Leadership", items: ["التوسع الإقليمي في المنطقة العربية", "تكامل IoT مع أجهزة الوزن والفرز", "الذكاء الاصطناعي التوليدي للتقارير"], itemsEn: ["Regional MENA expansion", "IoT integration with weighing & sorting", "Generative AI for reports"] },
];
