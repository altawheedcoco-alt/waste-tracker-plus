              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { year: '2024–2025', title: 'النضج والتوسع', desc: 'إطلاق الإصدار الثالث بهوية بصرية جديدة، ذكاء اصطناعي، وأدوات متقدمة لكل الأطراف.', icon: Sparkles, color: 'from-primary to-[hsl(200,75%,45%)]' },
                  ].map((m, i) => (
                    <motion.div
                      key={m.year}
