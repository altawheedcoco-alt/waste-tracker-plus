...
تم إنشاء هذا الإقرار تلقائياً فور تسجيل الشحنة في النظام.
يُقر المولّد بأنه قد سلّم أو سيُسلّم المخلفات المذكورة للناقل وفقاً للبيانات المسجلة في النظام.
يحق للمدوّر إلغاء هذا الإقرار مع ذكر الأسباب. يظل الإقرار محفوظاً في سجل الشحنة حتى بعد الإلغاء.`;
