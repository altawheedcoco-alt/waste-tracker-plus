...
const newsItems = [
  ...
  'تحويل النفايات بعيداً عن المحارق والمدافن والمكبات لخلق فرص صناعية بالنظام الدائري',
  ...
  'عمليات دعم مباشرة لتقليل كميات المخلفات الموجهة إلى المدافن أو المحارق — هدف صفر مخلفات',
  ...
  'شراء الأنواع المختلفة من المخلفات غير الخطرة وتوريدها لمصانع إعادة التدوير المتخصصة',
  ...
  'تصنيع البالتات الخشبية والأثاث الخشبي المتنوع والمنتجات الخشبية الأخرى',
  'تراخيص من الهيئة العامة للتنمية الصناعية وموافقات وزارة البيئة وعضوية اتحاد الصناعات المصرية',
  'تتبع النفايات بشكل مبسط لضمان الامتثال للمتطلبات الحكومية والبيئية والدولية',
  'جمع بيانات النفايات وإنشاء ملفات تعريف نفايات موحدة وتقارير تنظيمية متقدمة',
  'تحليل الاتجاهات في حجم النفايات والتكاليف على مستوى الموقع والشركة',
  'التوحيد للخدمات البيئية — أكثر عالمية وأكثر دقة وأكثر أماناً في تتبع المخلفات',
  'إعادة تدوير الأخشاب — تحويل الأخشاب المستخدمة إلى مواد قابلة للاستخدام الجديد',
  'صناعة الألواح الخشبية والأبواب والشبابيك والأرضيات من الأخشاب المعاد تدويرها',
  'تصنيع منتجات التعبئة والتغليف والبالتات والصناديق من الأخشاب المعاد تدويرها',
  'الحفاظ على البيئة واستدامة الموارد الطبيعية من خلال إعادة التدوير المتكاملة',
  'رؤية واسعة لجميع الجوانب البيئية تضمن تحقيق فوائد بيئية شاملة',
  'معالجة المخلفات بتحويلها إلى منتجات جديدة للحد من استهلاك المواد الخام والطاقة',
];
