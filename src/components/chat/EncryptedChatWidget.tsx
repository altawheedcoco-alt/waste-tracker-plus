              ...
              {selectedConvoId ? (
                <>
                  ...
                  <div className="flex items-center gap-1">
                    <ChatVideoCallButtonMini partnerName={selectedConvo?.partner?.full_name || ''} partnerUserId={selectedConvo?.partner?.user_id} partnerOrgId={selectedConvo?.partner?.organization_id} partnerLogo={selectedConvo?.partner?.avatar_url} />
                  </div>
                </>
              ) : (
