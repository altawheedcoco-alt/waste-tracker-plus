    ...
    <section id="stats" className="py-12 sm:py-24 relative overflow-hidden">
      ...
      <div className="container px-4 relative">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center p-4 sm:p-8 rounded-xl sm:rounded-2xl bg-card shadow-eco-sm hover:shadow-eco-md transition-all duration-300 border border-border/50 group animate-fade-in">
