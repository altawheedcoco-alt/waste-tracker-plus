    ...
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-[4.5rem] pb-4 sm:pt-28 sm:pb-0">
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-xl text-white font-semibold text-[11px] sm:text-sm border border-white/15 shadow-xl">
          ...
          <motion.h1
            className="text-[1.65rem] sm:text-5xl md:text-6xl lg:text-7xl font-black mb-3 sm:mb-5 leading-[1.15] px-2"
          ...
          <motion.div
            className="flex items-center justify-center gap-3 sm:gap-6 mb-5 sm:mb-7 px-4"
          ...
          >
            {statsItems.map((stat) => (
              <motion.div
                key={stat.label}
                className="flex flex-col items-center gap-1 px-3 sm:px-5 py-2.5 rounded-2xl bg-white/[0.07] backdrop-blur-md border border-white/10 group"
              ...
              >
                ...
                <span className="text-[9px] sm:text-xs text-white/55 font-medium">{stat.label}</span>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            ...
            <div className="grid grid-cols-3 sm:flex sm:flex-wrap items-center justify-center gap-x-5 gap-y-4 sm:gap-6 px-2 sm:px-4">
              {quickAccessItems.map((item, i) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all ring-2 ring-white/15 group-hover:ring-white/35 relative overflow-hidden`}>
                    <span className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-colors" />
                    <item.icon className="w-5 h-5 sm:w-7 sm:h-7 text-white relative z-10" />
                  </div>
                  <span className="text-[10px] sm:text-sm font-bold text-white group-hover:text-white transition-colors leading-tight max-w-[80px] sm:max-w-none">{item.label}</span>
          ...
          >
            ...
            <p className="text-sm sm:text-lg text-amber-400 font-bold tracking-[0.35em]" style={{ fontFamily: 'serif', textShadow: '0 0 12px rgba(251,191,36,0.4)' }}>
