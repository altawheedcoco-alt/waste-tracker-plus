    ...
    <section className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden pt-20 pb-8 sm:pt-20 sm:pb-0">
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main heading */}
          <motion.h1 
            className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-extrabold mb-3 sm:mb-6 leading-snug px-2 text-white drop-shadow-lg"
          ...
          <motion.p 
            className="text-sm sm:text-lg md:text-xl text-white/80 max-w-2xl mx-auto mb-6 sm:mb-10 px-4 leading-relaxed drop-shadow-md"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div 
            className="flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-4 px-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p 
            className="mt-3 sm:mt-6 text-[10px] sm:text-sm text-white/50"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
