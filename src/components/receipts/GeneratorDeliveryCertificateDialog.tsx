...
نُقر بأننا قد قمنا بتسليم المخلفات المذكورة أعلاه بكامل محتوياتها إلى ممثل جهة النقل المعتمدة، وأن البيانات المسجلة (النوع، الكمية، الحالة، درجة الخطورة) صحيحة ودقيقة وتمثل الواقع الفعلي لحظة التسليم.

ثانياً - صحة البيانات والتصنيف:
نتحمل المسؤولية الكاملة عن صحة بيانات المخلفات المُسلّمة، بما في ذلك التصنيف وفقاً لقائمة بازل الدولية، والكمية المُصرّح بها، ودرجة الخطورة المحددة. وأي بيانات مغلوطة أو مضللة تُعد مخالفة تستوجب المساءلة القانونية.

ثالثاً - الالتزام بالاشتراطات البيئية:
نُقر بأن المخلفات المُسلّمة قد تم فرزها وتجهيزها وتعبئتها وفقاً للاشتراطات البيئية والصحية المعتمدة من جهاز تنظيم إدارة المخلفات (WMRA)، وأنها مطابقة للوصف المسجل في النظام.

رابعاً - سلسلة الحيازة:
نُقر بأن هذا التسليم يمثل بداية سلسلة الحيازة (Chain of Custody) للشحنة، وأن أي تلاعب أو تغيير في محتويات الشحنة بعد لحظة التسليم لا يقع تحت مسؤوليتنا.

خامساً - المرجعية القانونية:
يخضع هذا الإقرار لأحكام قانون تنظيم إدارة المخلفات رقم 202 لسنة 2020 ولائحته التنفيذية، وقانون حماية البيئة رقم 4 لسنة 1994 المعدّل، واتفاقية بازل بشأن التحكم في نقل النفايات الخطرة والتخلص منها عبر الحدود.`;
        ...
        {isIssued && (
          <div className="p-4">
            ...
            >
              ...
              {/* === FOOTER === */}
              <footer className="mt-3 pt-2 text-center" style={{ borderTop: '1px solid #e5e7eb', fontSize: '6.5pt', color: '#9ca3af' }}>
                <p style={{ margin: 0 }}>
                  وثيقة رسمية صادرة إلكترونياً | رقم المرجع: {certNumber} | الشحنة: {shipment.shipment_number} | {currentDate} | يخضع لقانون 202/2020
                </p>
                <p style={{ margin: '2px 0 0 0' }}>
                  هذا المستند محمي ببصمة رقمية ولا يجوز تعديله أو تزويره - للتحقق امسح رمز QR
                </p>
              </footer>
            </div>
          </div>
