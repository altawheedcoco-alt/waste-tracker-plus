...
const EnhancedLocationPicker = ({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Location Selection Tabs with External Search */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="flex items-center gap-2 mb-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm" className="h-9 gap-1.5 px-2.5 flex-shrink-0">
                <ExternalLink className="w-4 h-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-56">
              <div className="px-2 py-1.5 text-sm font-semibold text-right">ابحث عن مكان في</div>
              <DropdownMenuItem 
                onClick={() => {
