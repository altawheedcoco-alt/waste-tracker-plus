    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0">
        ...
        <ScrollArea className="max-h-[calc(90vh-80px)]">
          <div ref={printRef} dir="rtl" style={{ fontFamily: "'Cairo', 'Segoe UI', Tahoma, sans-serif" }}>
            {/* Page 1 — Main Document */}
            <div style={{ padding: '8mm 10mm', width: '210mm', minHeight: '297mm', boxSizing: 'border-box', pageBreakAfter: 'always', display: 'flex', flexDirection: 'column' }}>
              {/* Header */}
