    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] p-0">
        ...
        <ScrollArea className="max-h-[calc(90vh-80px)]">
          <div ref={printRef} dir="rtl" style={{ padding: '40px', fontFamily: "'Cairo', 'Segoe UI', Tahoma, sans-serif" }}>
            {/* Header */}
            <div style={{ textAlign: 'center', borderBottom: '3px double #16a34a', paddingBottom: '20px', marginBottom: '20px' }}>
              <h1 style={{ color: '#16a34a', fontSize: '22px', margin: '0 0 4px', fontWeight: 'bold' }}>
              ...
              <p style={{ color: '#374151', fontSize: '12px', margin: '2px 0', fontWeight: '600' }}>Waste Delivery & Receipt Declaration</p>
              <p style={{ color: '#6b7280', fontSize: '11px', margin: 0 }}>وثيقة رسمية مؤمنة ومسجلة إلكترونياً — محمية ببصمة رقمية SHA-256</p>
            </div>

            {/* Shipment Info */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', margin: '20px 0', padding: '15px', background: '#f0fdf4', borderRadius: '8px', fontSize: '14px', border: '1px solid #86efac' }}>
            ...
            {/* Declaration Text */}
            <div style={{ whiteSpace: 'pre-wrap', lineHeight: '2', fontSize: '13px', margin: '20px 0', padding: '20px', border: '1px solid #e5e7eb', borderRadius: '8px', background: '#fffbeb' }}>
              {declaration.declaration_text}
            </div>

            {/* Legal Disclaimer */}
            <div style={{ padding: '12px 15px', background: '#fef2f2', border: '1px solid #fecaca', borderRadius: '8px', margin: '15px 0', fontSize: '11px', color: '#991b1b', lineHeight: '1.6' }}>
            ...
            <div style={{ borderTop: '2px solid #e5e7eb', paddingTop: '20px', marginTop: '20px' }}>
              ...
              <div style={{ border: '1px dashed #d1d5db', padding: '25px', textAlign: 'center', marginTop: '20px', borderRadius: '8px', color: '#9ca3af' }}>
                <p style={{ fontSize: '12px' }}>التوقيع الإلكتروني — تم التأكيد رقمياً عبر المنصة</p>
                <p style={{ fontSize: '10px', marginTop: '4px' }}>هذا الإقرار مسجل ومحمي ببصمة رقمية SHA-256 ولا يجوز تعديله أو التلاعب به</p>
              </div>
            </div>

            {/* Footer */}
            <div style={{ borderTop: '2px solid #e5e7eb', marginTop: '20px', paddingTop: '12px', textAlign: 'center', fontSize: '10px', color: '#6b7280' }}>
              ...
              <p style={{ margin: '6px 0 0 0', fontStyle: 'italic', color: '#16a34a', fontWeight: 'bold', fontSize: '10px' }}>
                {[
