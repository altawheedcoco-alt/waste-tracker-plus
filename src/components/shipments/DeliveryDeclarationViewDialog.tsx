...
const DeliveryDeclarationViewDialog = ({
  ...
  return (
    <UnifiedDocumentPreview
      ...
      title={`${declarationTitle} — ${declaration.shipment_number}`}
      filename={`إقرار-تسليم-${declaration.shipment_number}`}
    >
      <div dir="rtl" className="print-document w-full overflow-hidden" style={{ fontFamily: "'Cairo', 'Segoe UI', Tahoma, sans-serif" }}>
