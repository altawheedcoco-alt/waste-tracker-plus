  ...
  const dropdowns: NavDropdown[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'iRecycle Health', href: '/health', icon: Heart, desc: language === 'ar' ? 'منظومة صحية ذكية — 9 أدوات AI' : 'Smart health system — 9 AI tools', badge: language === 'ar' ? 'جديد' : 'New' },
          ...
          <div className="flex items-center justify-between h-9">
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                ...
                {language === 'ar' ? 'سلسلة iRecycle' : 'iRecycle Series'}
              </button>
            </div>
