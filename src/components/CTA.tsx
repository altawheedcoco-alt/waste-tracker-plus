        ...
        >
          ...
          <div className="relative py-10 px-4 sm:py-16 sm:px-8 md:py-20 md:px-16">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div 
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/20 text-white font-medium text-sm mb-6 backdrop-blur-sm"
              ...
              <motion.h2 
                className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 px-2"
              ...
              <motion.p 
                className="text-white/80 text-sm sm:text-lg max-w-2xl mx-auto mb-6 sm:mb-8 px-4"
                initial={{ opacity: 0 }}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                {benefits.map((benefit, i) => (
                  <motion.div 
                    key={i} 
                    className="flex flex-col items-center gap-2 p-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10 group"
              ...
              >
                <Button size="xl" className="bg-white text-primary hover:bg-white/90 shadow-lg hover:shadow-xl group relative overflow-hidden" onClick={() => navigate('/auth?mode=register')}>
