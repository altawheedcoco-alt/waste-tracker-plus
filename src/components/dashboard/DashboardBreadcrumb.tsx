...
const routeLabels: Record<string, string> = {
  ...
  // المدوّر
  'recycler-ai-tools': 'أدوات الذكاء الاصطناعي',
  'recycling-certificates': 'شهادات التدوير',
  'issue-recycling-certificates': 'إصدار شهادات التدوير',
  'pride-certificates': 'شهادات التميز',
  'wood-market': 'سوق الأخشاب',
  'commodity-exchange': 'بورصة السلع',
  'waste-flow-heatmap': 'خريطة تدفق المخلفات',
  'esg-reports': 'تقارير ESG',
  'detailed-waste-analysis': 'تحليل المخلفات التفصيلي',
  'circular-economy': 'الاقتصاد الدائري',
  'waste-auctions': 'مزادات المخلفات',
  'production': 'لوحة الإنتاج',
  'capacity-management': 'إدارة الطاقة الاستيعابية',
  'equipment-marketplace': 'سوق المعدات',
  'vehicle-marketplace': 'سوق المركبات',
  'waste-types': 'تصنيف المخلفات',
  'guilloche-patterns': 'أنماط الجيلوش',
  'futures-market': 'سوق العقود الآجلة',
  // السائق
  'driver-offers': 'عروض السائق',
  'driver-contracts': 'عقود السائق',
  'shipment-market': 'سوق الشحنات',
  'driver-wallet': 'محفظة السائق',
  'driver-onboarding': 'تسجيل سائق مستقل',
  'driver-trip-schedule': 'جدول الرحلات',
  // المولّد
  'generator-receipts': 'إيصالات المولّد',
  'create-receipt': 'إنشاء إيصال',
  'my-requests': 'طلباتي',
  'regulatory-updates': 'التحديثات التنظيمية',
  'operational-plans': 'الخطط التشغيلية',
  'regulatory-documents': 'المستندات التنظيمية',
  permits: 'التصاريح',
  'environmental-consultants': 'الاستشاريون البيئيون',
  'manual-operations': 'العمليات اليدوية',
  'quick-weight': 'إدخال وزن سريع',
  // إضافية
  'smart-inventory': 'المخزون الذكي',
  'b2c-collection': 'جمع المواطنين',
  'cross-impact': 'الأثر المتقاطع',
  'irecycle-health': 'صحة iRecycle',
