...
import { CalendarDays, TrendingUp, TrendingDown, Package, Clock, CheckCircle2, Truck, FileText } from 'lucide-react';
  ...
  const { data: stats, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        todayCompleted: todayData.filter(s => s.status === 'delivered' || s.status === 'confirmed').length,
