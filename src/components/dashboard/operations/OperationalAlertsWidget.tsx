...
const OperationalAlertsWidget = () => {
  ...
  return (
    <Card className="border-border/40 bg-card shadow-sm">
      ...
      <CardContent>
        <div className="max-h-[900px] overflow-y-auto scrollbar-thin scrollbar-thumb-border/60 hover:scrollbar-thumb-border scrollbar-track-transparent" style={{ scrollbarWidth: 'thin', scrollbarColor: 'hsl(var(--border) / 0.6) transparent' }}>
