...
const VoiceAssistantFAB = lazy(() => import('@/components/voice/VoiceAssistantFAB'));
    ...
    <TooltipProvider>
      <div className="h-screen bg-background flex overflow-hidden" dir="rtl">
        ...
        >
          ...
          {/* Voice Assistant */}
          <Suspense fallback={null}><VoiceAssistantFAB userRole={organization?.organization_type} /></Suspense>
        </div>
      </div>
    </TooltipProvider>
    </KeyboardShortcutProvider>
