...
const TransporterStatsGrid = ({ stats, isLoading }: TransporterStatsGridProps) => {
  const statCards: StatCardDef[] = [
    { title: 'إجمالي الشحنات', value: stats?.total || 0, subtitle: 'جميع الشحنات', icon: FileText },
    { title: 'الشحنات النشطة', value: stats?.active || 0, subtitle: 'قيد التنفيذ حالياً', icon: Truck },
