          ...
          <AnimatePresence>
            {!isCollapsed && (
              ...
              >
                ...
                {item.labelEn && (
                  <span className="block text-[9px] text-primary/60 font-normal leading-none mt-0.5">{item.labelEn}</span>
                )}
              </motion.div>
            )}
          </AnimatePresence>
      ...
      <AnimatePresence>
        {!isCollapsed && (
          <motion.div
            ...
            exit={{ opacity: 0, width: 0 }}
            transition={{ duration: 0.15 }}
            className="overflow-hidden whitespace-nowrap flex-1 text-right leading-tight"
          >
            <span className="text-sm">{item.label}</span>
            {item.labelEn && (
              <span className="block text-[9px] text-primary/60 font-normal leading-none mt-0.5">{item.labelEn}</span>
