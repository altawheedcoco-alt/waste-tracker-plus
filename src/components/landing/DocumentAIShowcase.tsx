...
const SolutionSection = memo(() => (
  <div className="py-16 sm:py-24 bg-gradient-to-b from-muted/50 to-background relative overflow-hidden">
    {/* Background pattern */}
...
const ImpactSection = memo(() => (
  <div className="py-16 sm:py-24 <div className="py-16 sm:py-24 bg-gradient-to-b from-muted/50 to-background">">
    <div className="container px-4">
      <motion.div 
        className="text-center mb-16"
        initial="hidden" whileInView="visible" viewport={{ once: true }}
...
const FeaturesSection = memo(() => (
  <div className="py-16 sm:py-24 <div className="py-16 sm:py-24 bg-gradient-to-l from-muted/50 to-background">">
    <div className="container px-4">
      <motion.div 
        className="text-center mb-16"
        initial="hidden" whileInView="visible" viewport={{ once: true }}
