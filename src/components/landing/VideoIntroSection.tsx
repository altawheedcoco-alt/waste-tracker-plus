  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-b from-background to-muted/30 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <div
          className="relative rounded-2xl overflow-hidden shadow-2xl border border-border bg-card aspect-video group cursor-pointer animate-fade-up"
        ...
        >
          ...
          <div
            className={`absolute inset-0 bg-gradient-to-br from-primary/80 via-emerald-600/70 to-teal-700/80 flex flex-col items-center justify-center transition-opacity duration-300 ${playing ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
          >
            ...
            <div className="relative z-10 w-20 h-20 md:w-24 md:h-24 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/40 flex items-center justify-center shadow-2xl group-hover:bg-white/30 group-hover:scale-110 active:scale-95 transition-all duration-200">
            ...
            <span className="absolute top-8 right-8 text-4xl opacity-30 animate-float-slow">♻️</span>
            <span className="absolute bottom-8 left-8 text-4xl opacity-30 animate-float-delayed">🌍</span>
          </div>
        </div>
      </div>
    </section>
