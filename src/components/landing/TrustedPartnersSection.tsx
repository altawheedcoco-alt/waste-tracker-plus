        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 mb-12">
          {partners.map((partner, i) => (
            ...
            >
              ...
              <h3 className="font-bold text-foreground text-xs sm:text-sm mb-1 leading-tight">{partner.name}</h3>
              <p className="text-[10px] sm:text-xs text-muted-foreground">{partner.role}</p>
            </div>
          ))}
        </div>
          ...
          <div className="relative px-6 py-8 sm:px-12 sm:py-12 text-center">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 text-white">
              <div className="text-center">
                ...
                <div className="text-white/80 text-xs sm:text-sm font-medium">محافظة مغطاة</div>
              </div>
              <div className="w-px h-12 bg-white/20 hidden sm:block" />
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black mb-1">100%</div>
                <div className="text-white/80 text-xs sm:text-sm font-medium">امتثال تشريعي</div>
              </div>
              <div className="w-px h-12 bg-white/20 hidden sm:block" />
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black mb-1">24/7</div>
                <div className="text-white/80 text-xs sm:text-sm font-medium">دعم فني متواصل</div>
              </div>
              <div className="w-px h-12 bg-white/20 hidden sm:block" />
              <div className="text-center">
                <div className="text-3xl sm:text-5xl font-black mb-1">ISO</div>
                <div className="text-white/80 text-xs sm:text-sm font-medium">معايير عالمية</div>
              </div>
            </div>
          </div>
        </div>
