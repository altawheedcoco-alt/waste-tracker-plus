  ...
  return (
    <div className={cn('space-y-3', className)}>
      ...
      <div className="relative rounded-lg overflow-hidden border" style={{ height }}>
        ...
        <MapboxMapComponent center={value || { lat: 26.8, lng: 30.8 }} zoom={value ? 15 : 6} selectedPosition={value} onPositionSelect={handlePositionSelect} height={height} clickable={true} />
      </div>
      {selectedAddress && (
