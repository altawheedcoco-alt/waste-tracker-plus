...
const accountGroups: { id: string; label: string; icon: any; hint?: string; accounts: DemoAccount[] }[] = [
  ...
  },
  {
    ...
    label: 'السائقون',
    icon: Car,
    hint: 'كيان مستقل — ليس جهة تشغيلية | المؤجر = رابط مؤقت فقط',
    accounts: [
      { email: 'company-driver@irecycle.test', label: 'سائق تابع', desc: 'موظف دائم بحساب كامل 🏢', icon: Truck, color: 'from-blue-500 to-indigo-700' },
      { email: 'independent-driver@irecycle.test', label: 'سائق مستقل', desc: 'نموذج Uber — عرض وطلب 🟢', icon: Zap, color: 'from-emerald-500 to-green-700' },
