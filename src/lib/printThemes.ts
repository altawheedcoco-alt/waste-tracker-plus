...
export const PRINT_THEMES: PrintTheme[] = [
  ...
  // === New Universal Themes ===
  {
    ...
    spacing: { pageMargin: '18mm', sectionGap: '20px', headerPadding: '22px' },
  ...
  },
  {
    ...
    spacing: { pageMargin: '22mm', sectionGap: '26px', headerPadding: '28px' },
  ...
  },
  {
    ...
    spacing: { pageMargin: '22mm', sectionGap: '24px', headerPadding: '24px' },
