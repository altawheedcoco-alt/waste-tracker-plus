...
export function generateGuillocheTextFillerHTML(accentColor = '#059669'): string {
  ...
  const verticalStamp = `<div style="position:fixed;left:17mm;top:50%;transform:rotate(-90deg) translateX(-50%);transform-origin:left center;z-index:1;pointer-events:none;user-select:none;white-space:nowrap;font-family:'Courier New','Cairo',monospace;font-size:7.5px;letter-spacing:1.5px;color:rgba(0,0,0,0.65);font-weight:900;direction:rtl;">
