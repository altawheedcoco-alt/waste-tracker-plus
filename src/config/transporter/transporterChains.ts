  ...
  chains: [
    ...
    // ═══════════════════════════════════════════
    {
      ...
      nodes: [
        ...
        { id: 'fn-smart-weigh', nodeType: 'function', labelAr: 'وزن ذكي (رفع الوزنة)', labelEn: 'Smart Weight Upload', bindingType: 'hybrid', icon: 'Scale', leadsTo: ['fn-deliver'] },
        ...
        { id: 'res-receipt', nodeType: 'result', labelAr: 'شهادة استلام', labelEn: 'Receipt Certificate', bindingType: 'hybrid', icon: 'FileText', leadsTo: ['eff-ledger', 'eff-custody', 'eff-carbon', 'eff-invoice'] },
        { id: 'eff-invoice', nodeType: 'effect', labelAr: 'إنشاء فاتورة مطالبة', labelEn: 'Generate Invoice', bindingType: 'partner', icon: 'Receipt' },
