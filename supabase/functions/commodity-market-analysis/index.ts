  ...
  "commodities": [
    ...
    },
    {
      ...
      "subtypes": [
        ...
        {"subtype": "pp", "name": "Polypropylene", "name_ar": "بولي بروبيلين", "current_price_usd": 380, "previous_price_usd": 375, "change_percent": 1.3, "trend": "stable", "source": "Plastics Exchange", "region_prices": [], "forecast_7d": 382, "forecast_30d": 385, "supply_demand": "balanced"}
      ]
    },
    {
      "type": "rdf",
      "name": "RDF & Alternative Fuel",
      "name_ar": "وقود بديل RDF",
      "subtypes": [
        {"subtype": "rdf_pellets", "name": "RDF Pellets", "name_ar": "حبيبات وقود بديل", "current_price_usd": 45, "previous_price_usd": 42, "change_percent": 7.1, "trend": "rising", "source": "Cement Industry", "region_prices": [], "forecast_7d": 47, "forecast_30d": 50, "supply_demand": "deficit", "alert": "مصانع الأسمنت تزيد الطلب على RDF - فرصة بيع ممتازة"},
        {"subtype": "biomass", "name": "Biomass", "name_ar": "كتلة حيوية", "current_price_usd": 35, "previous_price_usd": 33, "change_percent": 6.1, "trend": "rising", "source": "Energy Market", "region_prices": [], "forecast_7d": 36, "forecast_30d": 38, "supply_demand": "balanced"}
      ]
    },
    {
      "type": "wood",
      "name": "Wood & Pallets",
      "name_ar": "الخشب والطبالي",
      "subtypes": [
        ...
        {"subtype": "pallets", "name": "Wooden Pallets", "name_ar": "طبالي خشب", "current_price_usd": 12, "previous_price_usd": 11, "change_percent": 9.1, "trend": "rising", "source": "Trade Activity", "region_prices": [], "forecast_7d": 13, "forecast_30d": 14, "supply_demand": "deficit", "alert": "ارتفاع نشاط الموانئ يزيد الطلب على الطبالي"}
      ]
    },
    {
      "type": "glass",
      ...
      "subtypes": [
        ...
        {"subtype": "colored_glass", "name": "Colored Glass", "name_ar": "زجاج ملون", "current_price_usd": 30, "previous_price_usd": 32, "change_percent": -6.25, "trend": "falling", "source": "Local Market", "region_prices": [], "forecast_7d": 29, "forecast_30d": 28, "supply_demand": "surplus"}
      ]
    },
    {
      "type": "textiles",
    ...
    },
    {
      ...
      "subtypes": [
        ...
        {"subtype": "biogas_feedstock", "name": "Biogas Feedstock", "name_ar": "مواد خام بيوجاز", "current_price_usd": 25, "previous_price_usd": 24, "change_percent": 4.2, "trend": "rising", "source": "Biogas Plants", "region_prices": [], "forecast_7d": 26, "forecast_30d": 28, "supply_demand": "deficit"}
      ]
    }
  ],
